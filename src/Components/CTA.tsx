      ...
      <div className="relative z-10 gap-5 items-center lg:flex">
        <div className="flex-1 max-w-lg py-5 sm:mx-auto sm:text-center lg:max-w-max lg:text-left">
          ...
          <p className="text-gray-500 leading-relaxed mt-3">
            Empower your online presence with us. Build high-performance
            websites effortlessly, combining cutting-edge technology with
            intuitive design. Elevate your digital experience with our expert
            solutions.
          </p>
          <a
