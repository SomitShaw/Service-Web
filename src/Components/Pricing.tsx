export default () => {
  const plans = [
    {
      name: "Enterprise",
      desc: "Unleash the power of cutting-edge technologies with our Enterprise plan.",
      price: 1099,
      isMostPop: true,
      features: [
        "Robust Performance",
    ...
    {
      name: "Startup",
      desc: "Empower and embrace your startup's growth with our flexible plan.",
      price: 599,
      isMostPop: false,
      features: [
        "Robust Performance",
  ...
  return (
    <section className="relative py-6 bg-gray-900">
      <div
      ...
      <div className="relative max-w-screen-xl mx-auto text-gray-300 sm:px-4 md:px-8">
        <div className="max-w-xl mx-auto space-y-3 px-4 sm:text-center sm:px-0">
          ...
          <div className="max-w-xl">
            <p>
              Embrace scalability and financial flexibility in your web
              development journey with our 'Pay as You Grow' model. Efficient,
              cost-effective, and seamless expansion.
            </p>
          </div>
        </div>
        <div className="mt-16 justify-center sm:flex">
          {plans.map((item, idx) => (
            ...
            >
              <div className="p-4 py-10 space-y-4 border-b border-gray-700 md:p-8">
